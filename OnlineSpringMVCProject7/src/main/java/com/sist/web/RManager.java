...
//C:\springDev\springStudy\.metadata\.plugins\org.eclipse.wst.server.core\tmp1\wtpwebapps\OnlineSpringMVCProject7
@Component
public class RManager {
  public void graph(int no)
  {
	  try
	  {
		  ...
		  rc.voidEval("png(\"C:/springDev/springStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/OnlineSpringMVCProject7/naver"+no+".png\")");
