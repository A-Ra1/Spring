       ...
       <c:forEach var="fvo" items="${list }">
        <table class="table">
         <tr>
          ...
          <td width=65%>
           <h3><a href="../food/food_detail.do?no=${fvo.no }">${fvo.title }&nbsp;<span style="color:orange">${fvo.score }</span></a></h3>
          </td>
         </tr>
         <tr>
          <td width=65%>${fvo.addr1 }<br>${fvo.addr2 }</td>
         </tr>
         <tr>
