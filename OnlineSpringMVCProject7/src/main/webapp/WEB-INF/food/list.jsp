 	...
 	<div style="height:130px"></div>
      ...
      <div class="row">
        <div style="margin: 0px auto">
          ...
          <span class="btn btn-lg btn-success tabContent" value="r1">지역별 인기 맛집</span>
          <span class="btn btn-lg btn-success tabContent" value="r1">메뉴별 인기 맛집</span>
        </div>
       </div>
	        ...
	        <c:if test="${vo.no>=1 && vo.no<=12 }"> 
	          <div class="col-md-4">
	            <div class="product-item">
	              <a href="../food/food_category.do?no=${vo.no }"><img src="${vo.poster }" alt=""></a>
